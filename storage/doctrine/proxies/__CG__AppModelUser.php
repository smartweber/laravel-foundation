...
class User extends \App\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Model\\User' . "\0" . 'id', '' . "\0" . 'App\\Model\\User' . "\0" . 'name', '' . "\0" . 'App\\Model\\User' . "\0" . 'email', '' . "\0" . 'App\\Model\\User' . "\0" . 'password', '' . "\0" . 'App\\Model\\User' . "\0" . 'remember_token', '' . "\0" . 'App\\Model\\User' . "\0" . 'created_at', '' . "\0" . 'App\\Model\\User' . "\0" . 'updated_at', 'fillable', 'hidden');
        }
