...
class User extends \App\Models\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = array('name' => NULL, 'lastname' => NULL, 'email' => NULL, 'password' => NULL, 'type' => NULL, 'remember_token' => NULL, 'created_at' => NULL, 'updated_at' => NULL);
    ...
    {
        unset($this->name, $this->lastname, $this->email, $this->password, $this->type, $this->remember_token, $this->created_at, $this->updated_at);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'lastname', 'email', 'password', 'type', 'remember_token', 'created_at', 'updated_at');
        }
